      ...
      <div class="tb">
                    <table id="tbclient" class="table table-striped table-bordered table-hover text-center " cellspacing="0" width="100%">
                            ...
                            <tr>
                              ...
                              <th style="text-align: center;" data-priority="2">Imagen</th>
                              <th style="text-align: center;" data-priority="3">Correo</th>
                              <th style="text-align: center;" data-priority="5">Usuario</th>
                              <th style="text-align: center;" data-priority="6">Contraseña</th>
                              <th style="text-align: center;" data-priority="4">Acciones</th>
                            </tr>
                            </thead>
                            <tbody></tbody>
                             <tfoot>
  ...
  <div id="modal1" class="modal modal-fixed-footer  usuariomodal">
    ...
    <div class="modal-content">
      ...
      <form action="" id="frmadd" name="frmadd" class="center-align">
        ...
        <div class="input-field col s12 m12 l6 ">
              <input type="text" name="streetdir" title="Colonia/Calle o Avenida (*)" required="true" id="streetdir" style="text-align: center;">
              <label for="streetdir">Colonia/Calle o Avenida</label>
              <span class="" id="txtstreetdir"></span>
        </div>
        <div class="input-field col s12 m12 l6 ">
              <input type="text" name="numberdir" title="# Casa, Edificio, Nivel o Apartamento (*)" required="true" id="numberdir" style="text-align: center;">
              <label for="numberdir"># Casa, Edificio, Nivel o Apartamento</label>
              <span class="" id="txtnumberdir"></span>
        </div>
        <div class="input-field col s12 m12 l6 ">
              <input type="text" name="contact" title="Teléfono de contacto (*)" required="true" id="contact" style="text-align: center;">
