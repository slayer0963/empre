      ...
      $("#publish").click(function () {
         if(localStorage.getItem('nameper')==""){
            ...
            if($('#rate').swidget().value()>0){
                ...
                alert("¡Verifica si has puntuado el producto, esto nos sirve para mejorar como negocio!");
            }
        }
        else{
              alert("!Tú comentario está vacío!");
        }
                 ...
                 html+='<div class="media-area">';
                                     ...
                                     html+='<div class="media">';
                                         ...
                                         html+='<div class="media-body">';
                                             html+='<h4 class="media-heading">'+respu[i].fullname_cl+'<small>路 7 minutes ago</small></h4>';
                                             ...
                                             html+='<div class="media-footer">';
                                                html+='<a href="#pablo" class="btn btn-primary btn-simple pull-right" rel="tooltip" title="" data-original-title="Reply to Comment">';
                                                 ...
                                                 if(respu[i].rating>2.5){
                                                        html+='<span class="material-input">VALORACI脫N<div class="rating" style="color:green;" id="ratess">'+respu[i].rating+'</div></span>';
                                                 }
                                                 else{
                                                        html+='<span class="material-input">VALORACI脫N<div class="rating" style="color:red;" id="ratess">'+respu[i].rating+'</div></span>';
