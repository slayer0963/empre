...
<head>
    ...
    <title id="title">LOCAL CARAJADA</title>
                   ...
                   <div class="row">
                        <div class="col-md-4">
							<div class="card card-product card-plain">
								<div class="card-image">
									<a href="#pablo">
										<img src="../store/assets/img/examples/gucci.jpg" alt="" />
									</a>
								</div>
                        ...
                        <div class="col-md-4">
							<div class="card card-product card-plain">
								<div class="card-image">
									<a href="#pablo">
										<img src="../store/assets/img/examples/dolce.jpg" alt="" />
									</a>
								</div>
                        ...
                        <div class="col-md-4">
							...
							<div class="card card-product card-plain">
								<div class="card-image">
									<a href="#pablo">
										<img src="../store/assets/img/examples/tom-ford.jpg" alt="" />
									</a>
								</div>
